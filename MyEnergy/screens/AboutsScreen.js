...
//   const favMeals = MEALS.filter(meal => meal.id === 'm1' || meal.id === 'm2');
  return (    
    <SafeAreaView style={{flex: 1}}>
      ...
      <Text style={styles.text}>EcoWallet is a carbon footprint tracker that helps you learn more about your carbon emissions and carbon footprint from your daily lifestyle. EcoWallet can help you towards achieving a sustainable lifestyle, whether through sustainable travel, reducing your dietary carbon footprint, or removing CO2 by offsetting the CO2 emissions you can't avoid. </Text>
      <Text style={styles.title}>Owner: Foufikos Evangelos</Text>
      <Text style={styles.title}>Contact Info: efoufikos@inf.uth.gr</Text>
      <Text style={styles.title}>Version 1.0.3 (Beta) </Text>
